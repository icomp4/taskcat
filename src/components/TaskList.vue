          ...
          <tr>
            ...
            <th>
              <div class="header-cell">
                <span class="usage-value">{{totalUsage.cpu}}%</span>
                <span class="sort-label" @click="sortConfig = {key: 'cpu_usage', desc: !sortConfig.desc}">
                  CPU
                  <span v-if="sortConfig.key === 'cpu_usage'" class="sort-arrow">
                    {{ sortConfig.desc ? '↓' : '↑' }}
                  </span>
                </span>
              </div>
            ...
            <th>
              <div class="header-cell">
                <span class="usage-value">{{ formatMemory(totalUsage.memory) }}</span>
                <span class="sort-label" @click="sortConfig = {key: 'memory_usage', desc: !sortConfig.desc}">
                  Memory
                  <span v-if="sortConfig.key === 'memory_usage'" class="sort-arrow">
                    {{ sortConfig.desc ? '↓' : '↑' }}
                  </span>
                </span>
              </div>
...
th:nth-child(2) .header-cell,
th:nth-child(3) .header-cell {
 display: flex;
